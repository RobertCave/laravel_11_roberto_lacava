            ...
            <div class="col-12 col-md-6 justify-content-center">
                ...
                >
                    ...
                    <div class="mb-3">
                        ...
                        <input name="subtitle" type="text" class="form-control" id="subtitle" value="{{ old('descrizione') }}">
                    </div>

                    <div class="mb-3">
                        <label for="body" class="form-label">Corpo dell'Articolo</label>
                        <textarea name="body" class="form-control" id="body" cols="20" rows="8" value="{{ old('body') }}"></textarea>
                    </div>
